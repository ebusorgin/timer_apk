    ...
    document.body.innerHTML = `
      <div id="app">
        ...
        <div id="mainAppScreen" class="screen active">
          ...
          <div id="settingsOverlay" class="overlay" style="display:none;"><button id="btnBackFromSettings"></button><div id="settingsAvatar"></div><input id="inputSettingsName"><button id="btnSaveProfile"></button><span id="settingsUserId"></span><div id="adminLinkSection" style="display:none;"></div><button id="btnLogout"></button><input id="inputAvatarFile" type="file" style="display:none;"></div>
        </div>
