...
io.on('connection', (socket) => {
    ...
    // Используем setTimeout с небольшой задержкой, чтобы гарантировать, что клиент успел зарегистрировать обработчики
    // Клиент устанавливает обработчик внутри события connect, так что небольшая задержка гарантирует его регистрацию
    setTimeout(() => {
    ...
    }, 100); // 100ms задержка для гарантии регистрации обработчика на клиенте
    ...
    }, 100); // 100ms задержка для гарантии регистрации обработчиков на клиентах
