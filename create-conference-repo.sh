#!/bin/bash
# Скрипт для создания репозитория Conference

set -e

echo "🚀 Создание репозитория Conference..."
...
git commit -m "Initial commit: Conference project from timer_apk" || echo "Уже есть коммиты"
...
echo "   git remote add origin git@github.com:ebusorgin/conference.git"
echo ""
echo "📤 Затем запушите:"
