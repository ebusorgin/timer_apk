...
const DEFAULT_PROGRAMS = [
  ...
  { title: 'Алгоритмы и олимпиады', slug: 'алгоритмы-олимпиады', description: 'Подготовка к олимпиадам по программированию. Алгоритмы, структуры данных, решение задач.', age_min: 14, age_max: 18, duration_weeks: 36, lessons_per_week: 1, format: 'углублённый', school_type: 'tech' },
  ...
  { title: 'Графический дизайн', slug: 'графический-дизайн', description: 'Основы дизайна: композиция, типографика, работа в графических редакторах.', age_min: 14, age_max: 18, duration_weeks: 24, lessons_per_week: 1, format: 'углублённый', school_type: 'art' },
];
